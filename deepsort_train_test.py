...
if __name__ == '__main__':
    ...
    possible_com = PossibleCombination(person_image_num[0]+1,person_image_num[1] - person_image_num[0])
    ...
    for epoch in range(10):
        ...
        #print proporation of completeness
            if(times % 100 == 0 and times != 0):
                ...
                print("Finished {:.2f}%".format(times/len(possible_com)*100))
            ...
            cur_batch_x[0] = train_img_data[i[0] + 0][0]
            cur_batch_x[1] = train_img_data[i[1] + 0][0]
            cur_batch_x[2] = train_img_data[i[2] + 20][0]
