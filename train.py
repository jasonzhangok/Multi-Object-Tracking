...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "best_pruned.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default=ROOT/ "models/yolov5n_pruned.yaml", help="model.yaml path")
